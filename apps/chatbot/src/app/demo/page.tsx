...
const clientTheme: Partial<ThemeTokens> = {
  ...
  primaryColor: "#0f172a",
  primaryHoverColor: "#0b1220",
  primaryPressedColor: "#010814",
  primaryTextColor: "#fefce8",
  accentColor: "#f97316",
  accentLightColor: "#fed7aa",
  accentTextColor: "#0f172a",
  surfaceColor: "#0b1220",
  surfaceElevatedColor: "#0f172a",
  surfaceHoverColor: "#1b2538",
  surfaceMutedColor: "#11192c",
  surfaceContrastColor: "#f8fafc",
  borderColor: "#1e293b",
  borderLightColor: "#233147",
  mutedColor: "#94a3b8",
  textPrimaryColor: "#f8fafc",
  textSecondaryColor: "#cbd5f5",
  textTertiaryColor: "#94a3b8",
  textOnPrimaryColor: "#fefce8",
  ...
  systemBubbleBg: "#0d1526",
  systemBubbleText: "#94a3b8",
  secondaryColor: "#11192c",
  secondaryHoverColor: "#0f172a",
